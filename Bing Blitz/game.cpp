...
simulate_game(Input* input, float dt) {
	draw_rect(0, 0, arena_half_size_x, arena_half_size_y, 0x9d8cda);
	draw_arena_borders(arena_half_size_x, arena_half_size_y, 0x4f399f);
	...
	if (current_gamemode == GM_GAMEPLAY) {
		...
		if (hot_button == 0) {
			draw_text("SINGLE PLAYER", -80, -10, 1, 0xf87486);
			draw_text("MULTIPLAYER", 20, -10, 1, 0xf0defe);
		}
		else {
			draw_text("SINGLE PLAYER", -80, -10, 1, 0xf0defe);
			draw_text("MULTIPLAYER", 20, -10, 1, 0xf87486);
		}

		draw_text("BING BLITZZZZ", -73, 40, 2, 0x4f399f);
